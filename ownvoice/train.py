...
Architecture note (locked by /plan-eng-review, see design doc): single-
...
def inject_lora(
    ...
    *,
    ...
    of a raw stack trace (locked eng-review decision #4).
    """
...
def run_training_loop(
    ...
    Integration/manual-only per the design doc's test plan: this needs the
...
def train(config: TrainingConfig) -> TrainResult:
    ...
    eng-review decision), runs the training loop, generates one eval
